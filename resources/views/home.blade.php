    ...
    <div id="carouselExampleCaptions" data-bs-ride="carousel" data-bs-interval="2400" class="carousel slide mb-5">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/bit_ban1.png') }}" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/bit_ban2.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                ...
                <a href="#" onclick="alertModal('{{ __('system.coming_soon_notice') }}')">
                    <img src="{{ asset('images/bit_ban3.png') }}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
